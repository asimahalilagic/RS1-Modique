    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BannerAds", x => x.BannerAdId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SizeGuideId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CategoryId = table.Column<int>(type: "int", nullable: false),
                    TableUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SizeGuides", x => x.SizeGuideId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "BestsellerRankings",
                columns: table => new
                {
                    BestsellerRankingId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BestsellerRankings", x => x.BestsellerRankingId);
                    table.ForeignKey(
                        name: "FK_BestsellerRankings_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "ProductId");
                    table.ForeignKey(
                        name: "FK_ProductOptions_Sizes_SizeId",
                        column: x => x.SizeId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RelatedProductId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    RelatedToProductId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RelatedProducts_Products_RelatedToProductId",
                        column: x => x.RelatedToProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "ProductId");
                    table.ForeignKey(
                        name: "FK_ProductQuestions_Users_AdminUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DwellTimeSeconds = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SearchFilters", x => x.SearchFilterId);
                    table.ForeignKey(
                        name: "FK_SearchFilters_Brands_BrandId",
                        column: x => x.BrandId,
                        principalTable: "Brands",
                        principalColumn: "BrandId");
                    table.ForeignKey(
                        name: "FK_SearchFilters_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "CategoryId");
                    table.ForeignKey(
                        name: "FK_SearchFilters_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventoryLogs_ProductOptions_ProductOptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BestsellerRankings_ProductId",
                table: "BestsellerRankings",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryLogs_ProductOptionId",
                table: "InventoryLogs",
                column: "ProductOptionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductOptions_SizeId",
                table: "ProductOptions",
                column: "SizeId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductQuestions_AdminUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RelatedProducts_RelatedToProductId",
                table: "RelatedProducts",
                column: "RelatedToProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SearchFilters_BrandId",
                table: "SearchFilters",
                column: "BrandId");

            migrationBuilder.CreateIndex(
                name: "IX_SearchFilters_CategoryId",
                table: "SearchFilters",
                column: "CategoryId");
